...
const testimonials = [
  { name: 'Fatima Al-Rashidi', role: 'Working Mother', city: 'Riyadh', rating: 5, loss: '-15kg', duration: '5 months', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80', text: "I've been with Dr Diet for 5 months and lost 15kg without stepping foot in a gym. The food is genuinely delicious - my kids keep stealing my meals! The support team always responds quickly and the nutritionist actually remembers my goals every time we speak.", goal: 'Fat Loss' },
  { name: 'Khalid Al-Mansouri', role: 'Personal Trainer', city: 'Dubai', rating: 5, loss: '-20kg', duration: '4 months', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80', text: "I recommend Dr Diet to all my clients. The macros are spot-on, the quality is consistent, and the customer service actually responds. As a personal trainer, I need something I can trust to recommend. Dr Diet delivers every single time.", goal: 'Body Recomp' },
  { name: 'Lina Hassan', role: 'University Student', city: 'Jeddah', rating: 5, loss: '-8kg', duration: '6 weeks', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80', text: "As a student on a budget I was skeptical but the Starter plan is so worth it. I've lost 8kg in 6 weeks and actually have energy for classes now. The meals are so good my roommates want me to share!", goal: 'Weight Loss' },
  { name: 'Mohammed Al-Ghamdi', role: 'Engineer', city: 'Dammam', rating: 5, loss: '-25kg', duration: '6 months', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&q=80', text: "Six months ago I weighed 105kg. Today I'm at 80kg with visible abs. I never thought I'd say that. Dr Diet changed everything. The Elite plan was worth every riyal - the weekly calls with my nutritionist kept me accountable and adjusting.", goal: 'Elite Transformation' },
  { name: 'Sara Al-Zahrani', role: 'Nurse', city: 'Riyadh', rating: 5, loss: '-12kg', duration: '3 months', avatar: 'https://images.unsplash.com/photo-1551836022-8b2858c9c69b?w=100&q=80', text: "Working night shifts makes eating healthy nearly impossible. Dr Diet solved that completely. I pre-set my delivery window, the meals are portioned and labeled, and I just eat. Effortless. Lost 12kg in 3 months working 12-hour shifts.", goal: 'Lifestyle' },
  { name: 'Tariq Bin Saad', role: 'CEO', city: 'Jeddah', rating: 5, loss: '-18kg', duration: '4 months', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&q=80', text: "Between board meetings and travel, I had zero time to think about food. Dr Diet handles it all. The Elite plan's dedicated account manager is exceptional - they adjusted my plan around my travel schedule seamlessly. Truly premium service.", goal: 'Exec Health' },
]
